      ...
      body: Container(child: Padding(
        ...
        child: GridView(children: [
            ...
            child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: Colors.green,),
              child: Column(
                ...
                children: [
                  ...
                  Text("Translate",style: TextStyle(color: Colors.white,fontSize: 30),)
                ],),
            ),
          ),
          InkWell(
            ...
            child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: Colors.green,),
              child: Column(
                ...
                children: [
                  Icon(Icons.settings,size: 50,color: Colors.white,),
                  Text("Med Planner",style: TextStyle(color: Colors.white,fontSize: 30),)
                ],),
            ),
          ),     InkWell(
            onTap: (){
          ...
          InkWell(
            ...
            child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: Colors.orange,),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.book,size: 50,color: Colors.white,),
                  Text("Hospitals",style: TextStyle(color: Colors.white,fontSize: 30),)
                ],),
            ),
          ),
        ],
